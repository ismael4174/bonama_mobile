  ...
  const fetchElevesInscrits = () => {
    db.transaction(tx => {
      let query = `
        ...
        WHERE ei.presouscrit = 1 AND ei.anneescolaires_id = ? AND et.drenas_id = ?
      `;
    ...
    OR UPPER(et.nometablissement) LIKE ?
  ...
  return (
    <View style={styles.container}>
      ...
      <PaperTextInput
        ...
        placeholder="Rechercher par nom, matricule, prénom ou établissement"
        value={searchText}
...
export default ElevesInscrits1;
